...
def coinCount(coinMat, i):
	...
	while num_pic <= numImages:
		######## Loading #######
		string_for_image = "coin" + "_" + "s" + str(i) + "_" + str(num_pic) + '.jpg'
...
standard_picture_size = cv2.imread("coin_s1_2.jpg")
standard_picture_size = standard_picture_size.shape
row = standard_picture_size[0]
col = standard_picture_size[1]
channels = standard_picture_size[2]
numImages = 10
input_image = row * col * channels * numImages

coinCount(input_image, 1)
